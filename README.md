# LR_Stefan
A CPU time comparison for linearised and regularised solvers with Newton in the case of the stochastic Stefan problem is analysed in this code.
...
The solvers for the deterministic case can be accessed from the folder "LR_solvers" while the CPU time comparison can be performed via "LR_CPU_comparison".
