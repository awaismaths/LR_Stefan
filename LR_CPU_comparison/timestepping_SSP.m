function [ITER,Res]=timestepping_SSP(tol,zcase,ucase,bmm,dW,ncell,nvert,area,cg,cell_v,X,Mass,A,B_indices,I_indices,imesh,Ndt,dt,bdry_vert,mesh,h)
%global ucase zcase
%tol=1e-8;
itermax=1000;
forcediff=1;
...
%save(strcat('solutions/SSP_BM',num2str(bmm),'mesh',mesh(5:7),'tcuz',num2str(ucase),num2str(zcase)),'usol_idt','dt','Ndt','mesh','h');
end