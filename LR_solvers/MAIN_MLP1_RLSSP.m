%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mass-lumped P1 codes with different solvers (Regularised)
...
%         end;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    parfor bmm=1:nbm
        timestepping_RLSSP(tol,ep,Lc,zcase,ucase,bmm,W(:,bmm),ncell,nvert,area,cg,cell_v,X,Mass,L,A,G,B_indices,I_indices,imesh,Ndt(imesh),dt,bdry_vert,meshes{imesh},h);
