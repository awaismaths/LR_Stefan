...
%Computing for each Brownian motion       
    for bmm=1:nbm
        ...
        CS=load(strcat('solutions/LBM',num2str(bmm),'mesh',meshes{imesh}(1:8),'tcuz',num2str(ucase),num2str(zcase)));
        FS=load(strcat('solutions/LBM',num2str(bmm),'mesh',meshes{nbmeshes}(1:8),'tcuz',num2str(ucase),num2str(zcase)));
...
h=[C_h;F_h];
filenameE=strcat('norms/T1LME',meshes{nbmeshes}(8:8),'bm',num2str(nbm),'.dat');
filenameV=strcat('norms/T1LMV',meshes{nbmeshes}(8:8),'bm',num2str(nbm),'.dat');
